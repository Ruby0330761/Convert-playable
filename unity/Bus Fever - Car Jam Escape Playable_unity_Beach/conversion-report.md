...
- Input: `applovin/Bus Fever - Car Jam Escape Playable_applovin_Beach.html`
- Output package: `unity/Bus Fever - Car Jam Escape Playable_unity_Beach/Bus Fever - Car Jam Escape Playable_unity_Beach.html`
- Package size after Unity hardening: `3915671` bytes
- File count: `1`
...
- Desktop `1280x720`: canvas `322x664`, no page overflow, rendered pixel entropy `6.162`.
- Mobile `390x844`: canvas `390x780`, no page overflow, rendered pixel entropy `6.341`.
- Animation check: `9.02%` of sampled screenshot color channels changed over one second.
