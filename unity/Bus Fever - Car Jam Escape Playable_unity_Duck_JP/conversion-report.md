...
- Input: `applovin/Bus Fever - Car Jam Escape Playable_applovin_Duck_JP.html`
- Output package: `unity/Bus Fever - Car Jam Escape Playable_unity_Duck_JP/Bus Fever - Car Jam Escape Playable_unity_Duck_JP.html`
- Package type: single HTML
- Package size after Unity hardening: `4145222` bytes
- File count: `1`
...
- Desktop `1280x720`: canvas `1280x720`, no page overflow, rendered pixel entropy `4.286`.
- Mobile `390x844`: canvas `390x844`, no page overflow, rendered pixel entropy `6.801`.
- Animation check: `12.10%` of sampled screenshot color channels changed over one second.
